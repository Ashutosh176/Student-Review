  ...
  return (
    <div className="px-4 pb-8 pt-4 sm:px-7">
      <Helmet>
        ...
        <meta name="description" content={inst.description ?? `Student reviews and ratings for ${inst.name}.`} />
        <link rel="canonical" href={`${window.location.origin}/college/${inst.slug}`} />
      </Helmet>
